...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, target, enemy_type="zombie"):
        ...
        if enemy_type == "zombie":
            size = (100, 90);  color = RED;              self.speed = random.uniform(1.5, 2.5);  self.hp = 20
        elif enemy_type == "slime":
            size = (80, 70);   color = (0, 200, 100);   self.speed = random.uniform(1.2, 2.0);  self.hp = 12
        elif enemy_type == "goblin":
            size = (90, 80);   color = (0, 150, 0);     self.speed = random.uniform(2.0, 3.0);  self.hp = 45
        elif enemy_type == "skeleton":
            size = (95, 95);   color = (200, 200, 200); self.speed = random.uniform(2.5, 3.5);  self.hp = 80
        elif enemy_type == "golem":
            size = (130, 130); color = (100, 80, 60);   self.speed = random.uniform(1.0, 1.8);  self.hp = 180
        elif enemy_type == "bat":
            size = (70, 60);   color = (80, 0, 80);     self.speed = random.uniform(3.0, 4.5);  self.hp = 30
            ...
            size = (200, 200); color = (180, 30, 0);    self.speed = random.uniform(1.0, 1.5);  self.hp = 500
        elif enemy_type == "yeti":
            size = (200, 200); color = (200, 230, 255); self.speed = random.uniform(1.2, 1.8);  self.hp = 700
        elif enemy_type == "minotaur":
            size = (220, 220); color = (120, 40, 10);   self.speed = random.uniform(1.5, 2.2);  self.hp = 1000
        else:  # boss genérico
