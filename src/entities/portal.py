...
class Portal(pygame.sprite.Sprite):
    def __init__(self, pos):
        ...
        # Intentamos cargar un sprite, si no existe dibujamos el portal proceduralmente
    ...
    def update(self):
        ...
        # Efecto de pulso: el portal oscila ligeramente de tamaño
    ...
    def draw_procedural_portal(self, size):
        """Dibuja un portal animado sin necesidad de sprite externo."""
        cx, cy = size // 2, size // 2
        r = size // 2
        ...
        # Centro brillante con rotación simulada
    ...
    def kill(self):
        # Paramos el sonido si el portal desaparece
        if self.portal_sound:
